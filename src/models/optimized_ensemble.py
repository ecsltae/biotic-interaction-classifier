...
OPTIMIZED_CONFIG = {
    'biomedbert_6k': {
        'model_path': '/home/egaillac/MetaP/classifier/models/transformer_BiomedBERT_model_6k_original',
        'weight': 0.25,
        'max_length': 256,
    },
    'biomedbert_20k': {
        'model_path': '/home/egaillac/MetaP/classifier/models/transformer_BiomedBERT_model_enhanced_20k',
        'weight': 0.25,
        'max_length': 256,
    },
    'biomedbert_quality_v2': {
        'model_path': '/home/egaillac/MetaP/classifier/models/transformer_BiomedBERT_quality_v2',
        'weight': 0.25,
        'max_length': 256,
    },
    'biobert': {
        'model_path': '/home/egaillac/MetaP/classifier/models/transformer_biobert_model',
        'weight': 0.25,
        'max_length': 256,
    },
}
...
if __name__ == '__main__':
    ...
    # Load eval100
    eval_df = pd.read_csv('/home/egaillac/MetaP/classifier/data/evaluation/eval_100.tsv', sep='\t')
