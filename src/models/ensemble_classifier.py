...
ENSEMBLE_CONFIG = {
    ...
    'roberta': {
        'name': 'roberta-base',
        'model_path': '/home/egaillac/MetaP/classifier/models/transformer_roberta_model',
...
def train_ensemble(data_dir='/home/egaillac/MetaP/classifier/data/training'):
    """
    ...
    save_dir = '/home/egaillac/MetaP/classifier/ensemble_model'
...
def main():
    ...
    parser.add_argument('--data_dir', type=str,
                       default='/home/egaillac/MetaP/classifier/data/processed',
                       help='Data directory')
