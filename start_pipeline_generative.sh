...
GENERATIVE_MODEL_PATH="${1:-/home/egaillac/MetaP/classifier/models/flan_t5_enriched}"
export GENERATIVE_MODEL_PATH

export PYTHONPATH="/home/egaillac/MetaP/classifier/src:/home/egaillac/MetaP/classifier"
