...
cd /home/egaillac/MetaP/classifier/api
...
mkdir -p /home/egaillac/MetaP/classifier/logs

# Use the MetaP venv
PYTHON=/home/egaillac/MetaP/MPvenv/bin/python

# Start with nohup
echo "Starting FastAPI Ensemble API..."
nohup $PYTHON /home/egaillac/MetaP/classifier/api/fastapi_ensemble.py > /home/egaillac/MetaP/classifier/logs/api.log 2>&1 &

# Get the PID
API_PID=$!
echo $API_PID > /home/egaillac/MetaP/classifier/api/api.pid
...
echo ""
echo "Log file: /home/egaillac/MetaP/classifier/logs/api.log"
echo "============================================"
