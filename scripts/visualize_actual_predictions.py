...
output_dir = Path("/home/egaillac/MetaP/classifier/figures")
...
ensemble_df = pd.read_csv('/home/egaillac/MetaP/classifier/results/predictions/predictions_Ensemble_F1optimized.csv')
comparison_df = pd.read_csv('/home/egaillac/MetaP/classifier/results/predictions/predictions_ALL_MODELS_comparison.csv')
...
cv_df = pd.read_csv('/home/egaillac/MetaP/classifier/results/cv_results/transformer_cv_results.csv')
