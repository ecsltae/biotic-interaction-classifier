...
check_5h() {
    ...
    if [ $elapsed -ge 5 ]; then
        ...
        nohup bash /home/egaillac/MetaP/classifier/scripts/pipeline_post_distill.sh \
            >> "$LOG" 2>&1 &
        exit 0
    fi
}
...
BASE = Path("/home/egaillac/MetaP/classifier")
...
json.dump(results, open("/home/egaillac/MetaP/classifier/results/ensemble_synthetic_eval.json","w"), indent=2)
