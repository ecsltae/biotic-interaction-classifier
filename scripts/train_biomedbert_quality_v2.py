#!/usr/bin/env python3
"""
Train BiomedBERT on the high-quality dataset v2
"""
...
DATA_FILE = f'{BASE_DIR}/data/training/training_data_quality_v2.csv'
MODEL_DIR = f'{BASE_DIR}/models/transformer_BiomedBERT_quality_v2'
...
def main():
    print("="*70)
    print("TRAINING BIOMEDBERT ON QUALITY V2 DATASET")
    print("="*70)
    ...
    # Save results
    results = {
        'model': 'BiomedBERT_quality_v2',
        'dataset': 'training_data_quality_v2.csv',
        'dataset_size': len(df),
    ...
    print(f"Comparison:")
    print(f"  BiomedBERT_6k_orig: F1=0.488")
    print(f"  Best Ensemble:      F1=0.500")
    print(f"  This model:         F1={eval_metrics['f1']:.3f}")
