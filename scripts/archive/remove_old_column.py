...
# Files to process
data_dir = Path("/home/egaillac/MetaP/classifier/data/evaluation")
files_to_process = [
...
processed_file = Path("/home/egaillac/MetaP/classifier/data/processed/predictions_with_BiomedBERT.csv")
