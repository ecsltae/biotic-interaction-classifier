...
% acl.sty's [review] option automatically replaces this with
% "Anonymous ACL submission" in the compiled PDF -- the real author block
% below is what appears once the "review" option is dropped for camera-ready.
\author{Esteban Gaillac, Emilie Pasche, Alexandre Flament, Julien Gobeill, Patrick Ruch \\ HES-SO Geneva / SIBiLS}
